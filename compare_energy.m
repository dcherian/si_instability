...
figure(3)
plot(t_en(1:tind)./86400,MKE(1:tind)./max(MKE(1:tind)),'b'); hold on
figure(4)
plot(t_en(1:tind)./86400,PE(1:tind)./max(PE(1:tind)),'b'); hold on
...
legend('me','ken')
figure(3)
plot(t_en(1:tind)./86400,MKE(1:tind)./max(MKE(1:tind)),'r'); hold on
legend('me','ken')
figure(4)
plot(t_en(1:tind)./86400,PE(1:tind)./max(PE(1:tind)),'r'); hold on
legend('me','ken')